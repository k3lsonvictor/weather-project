...
// Tipo para os dados de temperatura ao longo do dia
interface Hourly {
  timestamp: Date;
  temperature: number;
  weatherCode: number;
...
// Tipo para o estado das temperaturas
...
export function useWeatherData(latitude: number, longitude: number) {
  ...
  const params = {
    ...
    daily: ["weather_code", "temperature_2m_max", "temperature_2m_min", "daylight_duration", "sunshine_duration", "uv_index_max", "precipitation_sum", "rain_sum", "showers_sum", "snowfall_sum", "wind_speed_10m_max", "wind_direction_10m_dominant"],
