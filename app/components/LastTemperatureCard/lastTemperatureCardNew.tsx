...
export const LastTemperatureCardNew = ({lastTemperature, timezone}:{lastTemperature: LastTemperature, timezone: string | null}) => {
  ...
  return (
    <div className="
        bg-[#0C101D] rounded rounded-2xl h-auto w-full min-auto font-oswald font-semibold flex flex-col justify-center items-start p-12">
      <div className="flex justify-between w-full items-center">
        <div className="flex flex-col">
          <div className="text-[60px] mt-3">{lastTemperature.temperature}ºc</div>
