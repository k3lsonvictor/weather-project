  ...
  const Skeleton = ({ opacity }: { opacity: string }) => {
    return (
      <div style={{ opacity: opacity }}>
        ...
        {type === 1 ? (
          <div
            className={`animate-pulse relative w-full flex bg-white ${height} px-6 py-9 border border-white border-transparent bg-grey/25 rounded-xl items-center flex-col lg:flex-row mb-2 `}
          >
            <div className="lg:mr-10 w-full lg:w-[250px] flex items-center  lg:mb-0  ">
              <div className="!h-[30px] !min-w-[30px] !w-[30px] aspect-square rounded-full bg-white bg-medium-grey mr-4"></div>
              <div>
                <div className="h-[13px] w-[200px] rounded-full bg-white bg-medium-grey mr-4"></div>
                <div className="h-[13px] w-[200px] rounded-full bg-white bg-medium-grey mr-4 mt-3"></div>
              </div>
            </div>
          </div>
        ) : type === 2 ? (
  ...
  const Skeleton = ({ opacity }: { opacity: string }) => {
    return (
      <div style={{ opacity: opacity }} className="mr-4">
        ...
        {type === 1 ? (
          <div
            className={`animate-pulse relative w-full inline-flex bg-white ${height}  px-6 py-9 border border-white border-transparent bg-grey/25 rounded-3xl items-start flex-col lg:flex-row mb-2 `}
          >
            <div className="lg:mr-10 w-full lg:w-[220px] flex items-start justify-start  lg:mb-0 ">
              <div className="!h-[30px] !min-w-[30px] !w-[30px] aspect-square rounded-full bg-white bg-medium-grey mr-3"></div>
              <div>
                <div className="h-[13px] w-full rounded-full bg-white bg-medium-grey mr-4"></div>
                <div className="h-[13px] w-[150px] rounded-full bg-white bg-medium-grey mr-4 mt-3"></div>
              </div>
            </div>
          </div>
        ) : (
          <div className="animate-pulse relative w-full flex bg-white mb-2  px-6 py-6 border border-white border-transparent bg-grey/25 rounded-xl items-center flex-col lg:flex-row  mr-4  ">
  ...
  return (
    <div className="w-full flex flex-col grayscale animate-pulse">
      <div className="">
        ...
        >
          <div
            className={`md:max-w-[70%] bg-white bg-[#363638] py-2 px-2 min-w-[50px] rounded-xl relative`}
            style={{ boxShadow: `0 1px .5px rgba(11,20,26,.13)` }}
          >
            <div className="py-10 px-20 w-[300px]"></div>
            <div
              className="bg-[url(/whatsapp/balloon-white.svg)] !z-[-1]  bg-[url(/whatsapp/balloon-white-dark.svg)]"
              style={{
                transform: "scaleX(-1)",
                width: "20px",
                height: "20px",
      ...
      <div className="">
        <div className={`pl-10 md:pl-20 flex flex-col items-end w-full mb-3`}>
          <div
            className={`md:max-w-[70%] py-2 px-2 rounded-xl relative bg-[#DCF7C5] bg-[#054640]`}
            style={{ boxShadow: `0 1px .5px rgba(11,20,26,.13)` }}
          >
            <div className="py-10 px-20 w-[400px]"></div>
            <div
              className="bg-[url(/whatsapp/balloon-green.svg)] !z-[-1]  bg-[url(/whatsapp/balloon-green-dark.svg)]"
              style={{
                transform: "scaleX(-1)",
                width: "20px",
                height: "20px",
...
export const SkeletonLoadingSquares = ({
  number,
  height = "h-[140px]",
}: {
  number: number;
  ...
  const Skeleton = ({ opacity }: { opacity: string }) => {
    return (
      <div style={{ opacity }} className="mr-2">
        <div
          className={`animate-pulse relativeinline-flex bg-white !w-[130px] !h-[130px] border border-white border-transparent bg-grey/25  items-start flex-col lg:flex-row mb-2 `}
        >
        </div>
      </div>
    );
